...
export const AppleLogo = () => (
  <svg width="13" height="13" viewBox="0 0 384 512" aria-label="Apple">
...
export function SsoLogos({ google, apple }: { google?: boolean; apple?: boolean }) {
  if (!google && !apple) {
    return <span className="text-[0.6rem] text-slate-600">—</span>
  }
  return (
